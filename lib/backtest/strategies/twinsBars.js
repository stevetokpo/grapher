// Stratégie basée sur le pattern Twins Bars existant (lib/twins/detect.js, que
// lib/patterns.js réexporte) :
...
export default {
  ...
  params: [
    ...
    // Balayage du swing précédent : la paire doit avoir dépassé la dernière
    // structure d'en face. Option, éteinte par défaut — donc balayable comme
    // n'importe quel filtre, et c'est le seul moyen de savoir ce qu'elle apporte.
    { key: 'swingFilter',     label: 'Exiger le balayage du swing',  type: 'bool',   def: false },
    { key: 'swingBars',       label: 'Bougies g/d du swing',         type: 'int',    def: 2,     min: 1,   max: 50 },
  ...
  setup(candles, p) {
    ...
    const signals = calcTwinsBars(candles, {
      ...
      swingFilter:     p.swingFilter,
      swingBars:       p.swingBars,
    });
