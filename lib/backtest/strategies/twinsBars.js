...
export default {
  ...
  params: [
    ...
    { key: 'lookback',        label: 'Bougies à mèches avant (0 = off)', type: 'int', def: 4,    min: 0,   max: 20 },
    ...
    { key: 'atrMult',         label: 'Multiplicateur ATR filtre',    type: 'float',  def: 1.6,   min: 1,   max: 5,  step: 0.1 },
