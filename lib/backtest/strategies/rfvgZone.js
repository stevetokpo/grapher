...
export default {
  ...
  params: [
    ...
    { key: 'mode',        label: 'Motifs retenus',            type: 'select', def: 'rfvg',  options: ['rfvg', 'all', 'super'], hint: 'rfvg = centrale à contre-courant de la MM ; all = tout motif de base (aFVG, rFVG inclus) ; super = sous-ensemble des rFVG dont la 3e bougie clôture à contre-sens du motif' },
