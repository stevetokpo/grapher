...
export const STYLE_DEFAULTS = {
  ...
  //               retourner.
  // Dans les deux cas le trait prend le sens du TRADE, donc du second motif.
  zoneStyle:  'boites',
  pivotWidth: 3,
};
...
export const FIELDS = [
  ...
  { kind: 'segmented', key: 'zoneStyle', label: 'Dessin de la figure', options: [
    { value: 'boites',  label: 'Les 2 FVG' },
    { value: 'trait',   label: 'Pivot' },
